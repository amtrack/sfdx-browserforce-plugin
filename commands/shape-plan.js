...
const ExternalSharing = require("../plugins/external-sharing");

module.exports = {
  topic: "shape",
  command: "plan",
  description: "plan an org shape",
  help: "help text for browserforce:shape:plan",
  flags: [
    {
      name: "definitionfile",
      char: "f",
  ...
  run(context) {
    const DRIVERS = { ExternalSharing: ExternalSharing };

    let targetUsername = context.flags.targetusername;
    let definitionfile = context.flags.definitionfile;
