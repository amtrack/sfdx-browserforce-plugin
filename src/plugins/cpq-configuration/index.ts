...
const SELECTORS = {
  ...
  LINE_EDITOR: 'td[id="page:form:pb:j_id125_lbl"]', // Confirmed
  VISUALIZE_PRODUCT_HIERARCHY: 'input[id="page:form:pb:j_id126:j_id135"]', // Confirmed
  KEEP_BUNDLE_TOGETHER: 'input[id="page:form:pb:j_id126:j_id139"]', // Confirmed
  TOTALS_FIELD: 'select[name="page:form:pb:j_id126:j_id141:j_id143"]', // Confirmed
  LINE_SUBTOTALS_TOTAL_FIELD: 'select[name="page:form:pb:j_id126:j_id153:j_id155"]', // Confirmed
  ADDITIONAL_SETTING: 'td[id="page:form:pb:j_id263_lbl"]', // Confirmed
  MULTIPLE_BUNDLES_VIEW: 'select[name="page:form:pb:j_id274:j_id290:j_id292"]', // Confirmed
  PLUGINS: 'td[id="page:form:pb:j_id172_lbl"]', // Confirmed
  QUOTE_CALCULATOR_PLUGIN: 'input[id="page:form:pb:j_id173:j_id181"]', // Confirmed
  ...
  SUBSCRIPTIONS_AND_RENEWALS: 'td[id="page:form:pb:j_id206_lbl"]', // Confirmed
  CONTRACT_IN_FOREGROUND: 'input[id="page:form:pb:subscriptionAndRenewalSettings:j_id233"]', // Confirmed
  SAVE: 'input[name="page:form:j_id2:j_id3:j_id11"]' // Confirmed
};
